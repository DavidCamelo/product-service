...
public class RestClientUtil<T> {
    ...
    public RestClientResponse<T> create(String service, T dto, Class<T> tClass) {
        ...
        try {
            restClientResponse.setDTO(loadBalancedRestClientBuilder.build().post().uri("http://{service}/api/{service}", service, service).body(dto).retrieve().body(tClass));
        } catch (Exception ex) {
    ...
    public RestClientResponse<T> getById(String service, Long id, Class<T> tClass) {
        var restClientResponse = new RestClientResponse<T>();
        try {
            restClientResponse.setDTO(loadBalancedRestClientBuilder.build().get().uri("http://{service}/api/{service}/{id}", service, service, id).retrieve().body(tClass));
        } catch (Exception ex) {
            restClientResponse.setErrorDTO(handleException(ex));
        }
        return restClientResponse;
    ...
    public RestClientResponse<Page<T>> getAll(String service, FilterDTO filterDTO, Class<Page> tClass) {
        ...
        try {
            restClientResponse.setDTO(loadBalancedRestClientBuilder.build().get().uri("http://{service}/api/{service}", service, service).retrieve().body(tClass));
        } catch (Exception ex) {
            restClientResponse.setErrorDTO(handleException(ex));
        }
        return restClientResponse;
    ...
    public RestClientResponse<T> update(String service, Long id, T dto, Class<T> tClass) {
        var restClientResponse = new RestClientResponse<T>();
        try {
            restClientResponse.setDTO(loadBalancedRestClientBuilder.build().put().uri("http://{service}/api/{service}/{id}", service, service, id).body(dto).retrieve().body(tClass));
        } catch (Exception ex) {
            restClientResponse.setErrorDTO(handleException(ex));
        }
        return restClientResponse;
    ...
    public RestClientResponse<T> delete(String service, Long id) {
        var restClientResponse = new RestClientResponse<T>();
        try {
            loadBalancedRestClientBuilder.build().delete().uri("http://{service}/api/{service}/{id}", service, service, id).retrieve().toBodilessEntity();
        } catch (Exception ex) {
            restClientResponse.setErrorDTO(handleException(ex));
        }
        return restClientResponse;
